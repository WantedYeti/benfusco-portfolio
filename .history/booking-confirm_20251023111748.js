(function(){
  ...
  const buildContractHtml = ({ fullName, email })=>{
    ...
    const contractHTML = [
  `<p>This Portrait Photography Services Agreement ("Agreement") is made as of ${effectiveDate} (the "Effective Date") between ${clientNameLine}, with a primary address of ${clientAddressLine} and contact email of ${clientEmailLine} ("Client"), and ${photographerPerson} ("Photographer").</p>`,
