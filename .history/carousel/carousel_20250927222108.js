...
(function(){
  ...
  this.applyAspect();
    ...
    computeLayout(){
      ...
      const H = this.ui.viewport.clientHeight || 1;
      ...
      for (const slide of children){
        ...
        if (img && img.naturalWidth && img.naturalHeight){
          ...
          w = Math.max(160, H * r); // minimum width to avoid overly tiny columns
        } else {
          w = Math.max(160, this.ui.viewport.clientWidth / 3);
        }
